...
package com.dqs.shangri.wheelview;
...
import com.dqs.shangri.dialogtest.R;
...
public class WheelView extends View {
    ...
    /** 非当前条目的文字颜色 */
    private static final int ITEMS_TEXT_COLOR = 0xFFA9A9A9;

    /** 顶部和底部的阴影颜色 */
    //private static final int[] SHADOWS_COLORS = new int[] { 0xFF5436EE, 0x0012CEAE, 0x0012CEAE };
    private static final int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF };
    ...
    private void initData(Context context) {
        ...
        try {
            textSize = (int)context.getResources().getDimension(R.dimen.wheelview_textsize);
    ...
    private int getDesiredHeight(Layout layout) {
         ...
         */
        int desired = getItemHeight() * visibleItems - ITEM_OFFSET * 2 - ADDITIONAL_ITEM_HEIGHT + VALUE_OFFSET;
